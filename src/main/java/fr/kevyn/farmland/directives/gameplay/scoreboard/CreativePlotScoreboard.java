package fr.kevyn.farmland.directives.gameplay.scoreboard;

import fr.kevyn.farmland.directives.infrastructure.boardManager;
...
public class CreativePlotScoreboard {
    ...
    public static String formatWE(PlayerServer ps) {
        if (!ps.isWeActive()) {
